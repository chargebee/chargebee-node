...
// Actions: create, createForCustomer, createWithItems, list, subscriptionsForCustomer, contractTermsForSubscription, listDiscounts, removeScheduledCancellation, removeCoupons, update, updateForItems, changeTermEnd, reactivate, addChargeAtTermEnd, chargeAddonAtTermEnd, chargeFutureRenewals, editAdvanceInvoiceSchedule, removeAdvanceInvoiceSchedule, regenerateInvoice, importSubscription, importForCustomer, importContractTerm, importUnbilledCharges, importForItems, overrideBillingProfile, pause, cancel, cancelForItems, resume, move
...
const ListSubscriptionIdSchema = z.object({
...
const ListSubscriptionCustomerIdSchema = z.object({
  is: z.string().min(1).optional(),
  is_not: z.string().min(1).optional(),
  starts_with: z.string().min(1).optional(),
  in: z.string().regex(RegExp('^\\[(.*)(,.*)*\\]$')).optional(),
...
const ListSubscriptionItemIdSchema = z.object({
  is: z.string().min(1).optional(),
  is_not: z.string().min(1).optional(),
  starts_with: z.string().min(1).optional(),
  in: z.string().regex(RegExp('^\\[(.*)(,.*)*\\]$')).optional(),
...
const ListSubscriptionItemPriceIdSchema = z.object({
  is: z.string().min(1).optional(),
  is_not: z.string().min(1).optional(),
  starts_with: z.string().min(1).optional(),
  in: z.string().regex(RegExp('^\\[(.*)(,.*)*\\]$')).optional(),
...
const ListSubscriptionStatusSchema = z.object({
  is: z
    .enum([
      'future',
      'in_trial',
...
const ListSubscriptionCancelReasonSchema = z.object({
  is: z
    .enum([
      'not_paid',
      'no_card',
...
const ListSubscriptionCancelReasonCodeSchema = z.object({
  is: z.string().min(1).optional(),
  is_not: z.string().min(1).optional(),
  starts_with: z.string().min(1).optional(),
  in: z.string().regex(RegExp('^\\[(.*)(,.*)*\\]$')).optional(),
...
const ListSubscriptionRemainingBillingCyclesSchema = z.object({
...
const ListSubscriptionCreatedAtSchema = z.object({
...
const ListSubscriptionActivatedAtSchema = z.object({
  after: z.string().regex(RegExp('^\\d{10}$')).optional(),
  before: z.string().regex(RegExp('^\\d{10}$')).optional(),
  on: z.string().regex(RegExp('^\\d{10}$')).optional(),
  between: z.string().regex(RegExp('^\\[\\d{10},\\d{10}\\]$')).optional(),
...
const ListSubscriptionNextBillingAtSchema = z.object({
  after: z.string().regex(RegExp('^\\d{10}$')).optional(),
  before: z.string().regex(RegExp('^\\d{10}$')).optional(),
  on: z.string().regex(RegExp('^\\d{10}$')).optional(),
  between: z.string().regex(RegExp('^\\[\\d{10},\\d{10}\\]$')).optional(),
});
const ListSubscriptionCancelledAtSchema = z.object({
  after: z.string().regex(RegExp('^\\d{10}$')).optional(),
  before: z.string().regex(RegExp('^\\d{10}$')).optional(),
  on: z.string().regex(RegExp('^\\d{10}$')).optional(),
  between: z.string().regex(RegExp('^\\[\\d{10},\\d{10}\\]$')).optional(),
});
const ListSubscriptionHasScheduledChangesSchema = z.object({
  is: z.enum(['true', 'false']).optional(),
});
const ListSubscriptionUpdatedAtSchema = z.object({
  after: z.string().regex(RegExp('^\\d{10}$')).optional(),
  before: z.string().regex(RegExp('^\\d{10}$')).optional(),
  on: z.string().regex(RegExp('^\\d{10}$')).optional(),
  between: z.string().regex(RegExp('^\\[\\d{10},\\d{10}\\]$')).optional(),
});
const ListSubscriptionOfflinePaymentMethodSchema = z.object({
  is: z
    .enum([
      'no_preference',
      'cash',
...
const ListSubscriptionAutoCloseInvoicesSchema = z.object({
  is: z.enum(['true', 'false']).optional(),
});
const ListSubscriptionOverrideRelationshipSchema = z.object({
  is: z.enum(['true', 'false']).optional(),
});
const ListSubscriptionSortBySchema = z.looseObject({
  asc: z.enum(['created_at', 'updated_at']).optional(),
  desc: z.enum(['created_at', 'updated_at']).optional(),
});
const ListSubscriptionBusinessEntityIdSchema = z.object({
  is: z.string().min(1).optional(),
});
const ListSubscriptionChannelSchema = z.object({
...
const ListSubscriptionBodySchema = z.looseObject({
  limit: z.number().int().min(1).max(100).optional(),
  offset: z.string().max(1000).optional(),
  include_deleted: z.boolean().default(false).optional(),
  id: ListSubscriptionIdSchema.optional(),
  customer_id: ListSubscriptionCustomerIdSchema.optional(),
  item_id: ListSubscriptionItemIdSchema.optional(),
  item_price_id: ListSubscriptionItemPriceIdSchema.optional(),
  status: ListSubscriptionStatusSchema.optional(),
  cancel_reason: ListSubscriptionCancelReasonSchema.optional(),
  cancel_reason_code: ListSubscriptionCancelReasonCodeSchema.optional(),
  remaining_billing_cycles:
    ListSubscriptionRemainingBillingCyclesSchema.optional(),
  created_at: ListSubscriptionCreatedAtSchema.optional(),
  activated_at: ListSubscriptionActivatedAtSchema.optional(),
  next_billing_at: ListSubscriptionNextBillingAtSchema.optional(),
  cancelled_at: ListSubscriptionCancelledAtSchema.optional(),
  has_scheduled_changes: ListSubscriptionHasScheduledChangesSchema.optional(),
  updated_at: ListSubscriptionUpdatedAtSchema.optional(),
  offline_payment_method: ListSubscriptionOfflinePaymentMethodSchema.optional(),
  auto_close_invoices: ListSubscriptionAutoCloseInvoicesSchema.optional(),
  override_relationship: ListSubscriptionOverrideRelationshipSchema.optional(),
...
export type ListSubscriptionBody = z.infer<typeof ListSubscriptionBodySchema>;
