...
const ListEventIdSchema = z.object({
...
const ListEventWebhookStatusSchema = z.object({
  is: z
    .enum([
      'not_configured',
      'scheduled',
...
const ListEventEventTypeSchema = z.object({
  is: z
    .enum([
      'coupon_created',
      'coupon_updated',
...
const ListEventSourceSchema = z.object({
  is: z
    .enum([
      'admin_console',
      'api',
...
const ListEventOccurredAtSchema = z.object({
...
const ListEventSortBySchema = z.looseObject({
  asc: z.enum(['occurred_at']).optional(),
  desc: z.enum(['occurred_at']).optional(),
});
const ListEventBodySchema = z.looseObject({
  limit: z.number().int().min(1).max(100).optional(),
  offset: z.string().max(1000).optional(),
  start_time: z.number().int().optional(),
  end_time: z.number().int().optional(),
  id: ListEventIdSchema.optional(),
  webhook_status: ListEventWebhookStatusSchema.optional(),
  event_type: ListEventEventTypeSchema.optional(),
  source: ListEventSourceSchema.optional(),
  occurred_at: ListEventOccurredAtSchema.optional(),
  sort_by: ListEventSortBySchema.optional(),
});
export { ListEventBodySchema };
export type ListEventBody = z.infer<typeof ListEventBodySchema>;
