...
const ListHostedPageIdSchema = z.object({
...
const ListHostedPageTypeSchema = z.object({
  is: z
    .enum([
      'checkout_new',
      'checkout_existing',
...
const ListHostedPageStateSchema = z.object({
  is: z
    .enum([
      'created',
      'requested',
...
const ListHostedPageUpdatedAtSchema = z.object({
...
const ListHostedPageBodySchema = z.looseObject({
  limit: z.number().int().min(1).max(100).optional(),
  offset: z.string().max(1000).optional(),
  id: ListHostedPageIdSchema.optional(),
  type: ListHostedPageTypeSchema.optional(),
  state: ListHostedPageStateSchema.optional(),
  updated_at: ListHostedPageUpdatedAtSchema.optional(),
});
export { ListHostedPageBodySchema };
export type ListHostedPageBody = z.infer<typeof ListHostedPageBodySchema>;
